...
var Signal;
((Signal2) => {
  var _a, _State_instances, brand_fn, _b, _Computed_instances, brand_fn2;
  _a = NODE;
  class State {
    constructor(initialValue, options = {}) {
      __privateAdd(this, _State_instances);
  ...
  isState = (s) => __privateIn(_State_instances, s);
  Signal2.State = State;
  _b = NODE;
  class Computed {
    ...
    constructor(computation, options) {
      __privateAdd(this, _Computed_instances);
  ...
  _Computed_instances = new WeakSet();
  brand_fn2 = function() {
  };
  isComputed = (c) => __privateIn(_Computed_instances, c);
  Signal2.Computed = Computed;
  ((subtle2) => {
    var _a2, _Watcher_instances, brand_fn3, assertSignals_fn;
    function untrack(cb) {
      let output;
    ...
    class Watcher {
      ...
      watch(...signals) {
        ...
        __privateMethod(this, _Watcher_instances, assertSignals_fn).call(this, signals);
    ...
    isWatcher = (w) => __privateIn(_Watcher_instances, w);
